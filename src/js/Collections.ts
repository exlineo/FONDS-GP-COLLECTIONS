...
export class Collections extends CustomHTML {
    ...
    collections:Array<CollectionI> = [];
    notices:Array<NoticeI> = [];
    collection: any = {};
    notice: any = {};
    n:HTMLElement; // Notices HTML
    s; // L'entête des notices pour ecrires les séries
    elC: HTMLElement; // Collection HTML
    o: HTMLElement; // Notice HTML à afficher
    ...
    constructor(n: any, s: any, c: any, o: any, f: any) {
        ...
        this.f = f;
        addEventListener('collection', (e: any) => {
        ...
        addEventListener('collections', (e: any) => {
            console.log(e.detail);
            e.detail.forEach((c:CollectionI) => {
                console.log(c);
                this.setCollectionsMenu(c);
            })
        });
        /**
    ...
    setCollectionsMenu(c:CollectionI){
        this.elC.appendChild(this.setCollectionArticle(c));
    }
    /**
